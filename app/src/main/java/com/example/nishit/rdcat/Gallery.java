...
public class Gallery extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=1;i<=30;i++)
        {
            _images.add("http://ratnadeep.pe.hu/BALI/"+i+".jpg");
        }
        Assert.assertNotNull(_images);
        Intent intent = getIntent();
        _adapter = new GalleryPagerAdapter(this);
        _pager.setAdapter(_adapter);
        //_pager.setOffscreenPageLimit(Integer.parseInt(intent.getStringExtra("limit"))); // how many images to load into memory
        _pager.setOffscreenPageLimit(9);
